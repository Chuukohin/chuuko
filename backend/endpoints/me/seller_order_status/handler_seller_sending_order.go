...
// MeSellerSendingOrder
// @ID           me.seller_order_status.sending.get
// @Summary      Sending orders
// @Description  Sending orders
// @Tags         me_seller_order_status
// @Accept       json
// @Produce      json
// @Success      200  {object}  []sellerSendingOrderResponse
// @Failure      400  {object}  responder.ErrorResponse
// @Router       /me/seller_order/status/sending [get]
func MeSellerSendingOrder(c *fiber.Ctx) error {
